...
# Load Patella lead prediction model
load("SL_patx_pred.RData")
...
# Predict Patella lead concentration
pred_patx <-predict.SuperLearner(model_patx_min, newdata=predictors)$pred